...
include 'embrace/locations_model.emb.php';
...
<head>
	<?php 
		if (check_admin($_SESSION['id'],$mapName) == true){
			header("Location: admin-map.php?mn=".$mapName);
			exit;
		}
	?>
    <style>
    ...
    <script>
        ...
        var locations = <?php get_confirmed_locations($mapName) ?>;
		
        var myOptions = {
            zoom: 7,
            center: new google.maps.LatLng(34.048553, -118.230716),
            mapTypeId: 'roadmap'
        };
        ...
        function saveData(lat,lng) {
            ...
            var url = 'embrace/locations_model.emb.php?add_location&mn=<?php $mapN=$_GET['mn']; echo''.$mapN.''?>&description=' + description + '&lat=' + lat + '&lng=' + lng;
